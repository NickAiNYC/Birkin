...
description: |
  ...
  "dependency lock", "governance script executable", "Scrutexity repo check".
version: 1.0.0
  ...
  hermes:
    ...
    config:
      - key: governance.repos
        description: "Comma-separated list of Scrutexity repo paths"
        default: "~/Directora,~/LabBrief"
        prompt: "Enter paths to Scrutexity repos to monitor"
---

# Code Review & Governance Watch Skill

## When to Use
- Triggered on every git push to main on any Scrutexity repo (via webhook or cron poll)
- User asks: "review this PR", "check governance", "did tests get weaker", "contract version bump"
- Any request about code quality, governance compliance, or repo health in Scrutexity projects
