...
- **Action:** Unlock iPhone → tap "Birkin" icon on Home Screen (PWA)
- **Screen shows:** Open WebUI loads, dark mode, model dropdown shows "birkin"
...
- **End card:** Fade to black → show `https://github.com/NickAiNYC/birkin`
